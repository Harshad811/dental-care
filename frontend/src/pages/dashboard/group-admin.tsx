...
import { Hospital, Stethoscope, Users, DollarSign, Activity, Sparkles } from "lucide-react"
            ...
            <CardContent>
              <div className="grid gap-4 sm:grid-cols-3">
                ...
                <div className="rounded-lg bg-gray-50 p-4">
                  ...
                  <p className="mt-1.5 text-2xl font-bold text-gray-900">{stats?.total_doctors ?? 0}</p>
                </div>
                <div className="rounded-lg bg-gray-50 p-4">
